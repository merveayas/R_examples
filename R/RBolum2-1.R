...
install.packages("psych", repos="http://192.168.2.2/R/Repo")
install.packages("DescTools", repos="http://192.168.2.2/R/Repo")
install.packages("gmodels", repos="http://192.168.2.2/R/Repo")
install.packages("gplots", repos="http://192.168.2.2/R/Repo")
install.packages("PMCMRplus", repos="http://192.168.2.2/R/Repo")
install.packages("pgirmess", repos="http://192.168.2.2/R/Repo")
install.packages("dunn.test", repos="http://192.168.2.2/R/Repo")
data(mtcars)
attach(mtcars)
tapply(mpg,vs,mean)    # vs faktorune gore mpg ortalamalarini bulur
by(mpg,vs,mean)       # vs faktorune gore mpg ortalamalarini bulur
by(mpg,list(vs,am),mean)
