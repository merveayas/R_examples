#######  R ile Temel Istatistik 2019 Bolum 1-Kisim 1  ###########

##  Ucretsiz R Kitabi 
##  https://learningstatisticswithr.com/
## lsr0.6.pdf dosyasi web serverda mevcut.
...
d[[2]][2,]
e<-list(vektorum=a,matris=b,mantiksal=c)
e$vektorum
e[["vektorum"]]                      # liste icerisinde vektorum isimli bir vektore ulasiyoruz 
e[["vektorum"]][1]
is.matrix(e$matris)
